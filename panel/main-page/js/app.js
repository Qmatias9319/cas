...
function remove() {
  ...
  if (document.getElementById("nav_afiliados")) {
    document.getElementById("nav_afiliados").className = "nav-link";
  }
  ...
  if (document.getElementById("nav_solicitudes")) {
  ...
  if (document.getElementById("nav_modulo")) {
    document.getElementById("nav_modulo").className = "nav-link";
  }
