...
// $pdf->AddPage();
    ...
    $solicitud .= '<tr><td></td></tr><tr><td colspan="3">Préstamo Solicitado $US ' . $monto . ' </td><td colspan="3">Plazo: ' . $plazo . ' meses.</td></tr>';
    ...
    $textBody .= '<b>SEGUNDA.- (Objeto)</b> El PRESTATARIO declara que debe y pagará a la orden del ACREEDOR la suma de $US ' . $suma . ' (' . $sumaLiteral . '), que ha sido girada a solicitud expresa del prestatario a favor del proveedor, como consta en el Comprobante de Pago No. ' . $nroComprobante . ' de fecha ' . $fecha . '<br>';
